...
let first = new VillageState(
    ...
    { place: "Post Office", address: "Marketplace-Farm" }]
);
...
let vs0 = new VillageState('Post Office',
...
let memory0 = [];
memory0 = runRobot(vs0, routeRobot, memory0);
console.log(memory0);
...
memory0 = [];
memory0 = runRobot(vs0, goalOrientedRobot, memory0);
console.log(memory0);
...
function countSteps(state, robot, memory) {
  ...
  memory0 = runRobot(vs0, lazyRobot, []);
console.log(memory0);