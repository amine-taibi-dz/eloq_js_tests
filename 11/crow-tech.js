(function() {
  const connections = [
    ...
    "Chateau-Great Pine", "Great Pine-Jacques's Farm", "Jacques's Farm-Hawthorn",
    "Great Pine-Hawthorn", "Hawthorn-Gilles's Garden", "Great Pine-Gilles's Garden",
    "Gilles's Garden-Big Oak", "Gilles's Garden-Butcher Shop", "Chateau-Butcher Shop"
  ]
  ...
  function storageFor(name) {
    ...
    storage["cache under the hedge"] = "Middle of the hedge at Gilles's garden. Marked with a forked twig. Two bottles of beer."
    storage["enemies"] = ["Farmer Jacques's dog", "The butcher", "That one-legged jackdaw", "The boy with the airgun"]
    ...
    if (name == "Big Oak") storage.scalpel = "Gilles's Garden"
    else if (name == "Gilles's Garden") storage.scalpel = "Woods"
